> [!NOTE]
> 标题：星空StarrySky——多版本基岩版|6.0开启|已开6年|生存|冒险|自研插件|氛围温馨|公益|养老

# <span style="color: #9932cc;">星空StarrySky —— 你的方块世界温馨港湾</span>

**厌倦了快餐式的游戏体验？渴望找到一个充满温暖与陪伴的方块世界？**  
**星空StarrySky，一个已稳定运行6年的多版本基岩版生存服，诚挚邀请你的加入！**
...
### 服务器特色：
- **多版本支持**：使用魔改Nukkit-MOT服务端核心，实现支持基岩版全版本，满足不同版本玩家的需求。
- **长期稳定运行**：已稳定运行6年，拥有成熟的社区和管理体系。
